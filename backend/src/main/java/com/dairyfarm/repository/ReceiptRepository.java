...
public interface ReceiptRepository extends JpaRepository<Receipt, Long> {
    ...
    @Query("SELECT COUNT(r) FROM Receipt r WHERE r.customer = :customer AND r.paymentStatus != 'PAID'")
    Long countPendingReceiptsByCustomer(@Param("customer") Customer customer);
}
